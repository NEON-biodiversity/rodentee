...
Get rid of all recaptures and all juveniles. Other than that do no other quality control for now. Probably a good idea to look back through later and get rid of odd outliers. I chose to do 2016 for this analysis because it has the most data (about 10000 individuals). Get rid of any row without weight (leaving 7000 rows). Also keep only the columns we care about for the moment. 
